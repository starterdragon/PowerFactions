...
class FactionMain extends PluginBase implements Listener {
	...
	public function onEnable() {
		...
		$this->prefs = new Config($this->getDataFolder() . "Prefs.yml", CONFIG::YAML, array(
                ...
                "TheDefaultPowerEveryFactionStartsWith" => 50,
 ...
 /*   public function getAllAllies($faction){
	...
	public function formatMessage($string, $confirm = false) {
		if($confirm) {
			return "[" . TextFormat::GOLD . "FTech Factions" . TextFormat::WHITE . "] " . TextFormat::GREEN . "$string";
		} else {	
			return "[" . TextFormat::GOLD . "FTech Factions" . TextFormat::WHITE . "] " . TextFormat::RED . "$string";
		}
	}
